...
DispatchLoop is a synthetic field-service operations console for calling a professional, collecting a status update in English/Hindi/Hinglish, and applying only deterministic, auditable booking actions. 
## What is included
